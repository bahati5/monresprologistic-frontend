  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div
        ...
        style={{ background: "linear-gradient(135deg, #1e3a5f, #2B4C7E)" }}>
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20 text-white">
          ...
          <motion.div
            ...
            {[
              ...
              {
                icon: Shield,
                text: "Securite et transparence des transactions",
              },
            ].map((feat, i) => (
        ...
        <motion.div
          ...
          <Card className="border-0 shadow-xl lg:shadow-2xl">
            <CardHeader className="text-center pb-2">
              ...
              <CardDescription>
                Connectez-vous a votre compte Monrespro
              </CardDescription>
            </CardHeader>
